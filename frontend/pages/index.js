        ...
        <>
          <div className={styles.stats}>
            ...
            <div className={styles.stat}>
              <span>This year</span>
              <span>
                <Amount value={stats.byYear[today.getFullYear()]} />
              </span>
            </div>
            <div className={styles.stat}>
              <span>This month</span>
              <span>
                <Amount value={stats.byMonth[today.getFullYear()][today.getMonth() + 1]} />
              </span>
            </div>
            <div className={styles.stat}>
              <span>Average per month</span>
              <span>
                <Amount value={stats.byYear[today.getFullYear()] / (today.getMonth() + 1)} />
              </span>
            </div>
          </div>
          <hr />
